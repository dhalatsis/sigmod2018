...
// // for_3 join UNOPTIMIZED -- returns check_sum based on the join-columns, we need better
// // we assume that table_a->column_j->size <= table_b->column_j->size <= table_c->column_j->size
// uint64_t Joiner::for_3(table_t* table_a, table_t* table_b, table_t* table_c) {
